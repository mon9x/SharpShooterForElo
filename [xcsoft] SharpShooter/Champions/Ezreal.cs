...
namespace Sharpshooter.Champions
{
    public static class Ezreal
    {
        ...
        static void Killsteal()
        {
            ...
            foreach (AIHeroClient target in HeroManager.Enemies.Where(x => x.IsValidTarget(R.Range) && !x.HasBuffOfType(BuffType.Invulnerability) && !x.HasBuffOfType(BuffType.SpellShield)))
            {
